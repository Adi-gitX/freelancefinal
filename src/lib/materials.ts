...
export const materials: Material[] = [
  {
    ...
    image_url: "/samples/number1brazz.png",
    price_base: 89.99,
    lead_time_days: 5,
  ...
  },
  {
    ...
    image_url: "/samples/number2blackmarble.png",
    price_base: 129.99,
    lead_time_days: 7,
  ...
  },
  {
    ...
    image_url: "/samples/number3whitemarble.png",
    price_base: 129.99,
    lead_time_days: 7,
    engraving_depth: "1.0mm",
    features: [
  ...
  },
  {
    ...
    name: "Brushed Steel",
    type: "steel",
    description: "Brushed steel with modern finish",
    image_url: "/samples/number4.png",
    price_base: 69.99,
    lead_time_days: 3,
